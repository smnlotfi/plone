...
#
#  $ bin/test -s vollabor.app -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src vollabor.app.testing.VOLLABOR_APP_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/vollabor/app/tests/robot/test_example.robot
#
